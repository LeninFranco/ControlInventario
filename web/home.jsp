                ...
                <div id="content">
                    <section class="bg-light py-3">
                        <div class="container text-center">
                            <div class="row">
                                <div class="col-lg-12">
                                    <h1 class="font-weight-bold mb-0">Bienvenido al control de inventarios de ESCOM</h1>
                                    <p class="lead text-muted">En este proyecto vas a encontrar diferentes funcionalidades para manejar el
                                        inventario de tu negocio</p>
                                </div>
                            </div>
                        </div>
                    </section>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 stat my-3">
                                            <div class="mx-auto">
                                                ...
                                                <h3 class="font-weight-bold">Productos Disponibles</h3>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 stat my-3">
                                            <div class="mx-auto">
                                                <h6 class="text-muted">Administrar</h6>
                                                <h3 class="font-weight-bold">Categorias de Productos</h3>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 stat my-3">
                                            <div class="mx-auto">
                                                <h6 class="text-muted">Gestionar</h6>
                                                <h3 class="font-weight-bold">Entradas al Almacen</h3>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 stat my-3">
                                            <div class="mx-auto">
                                                <h6 class="text-muted">Gestionar</h6>
                                                <h3 class="font-weight-bold">Salidas del Almacen</h3>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 stat my-3">
                                            <div class="mx-auto">
                                                <h6 class="text-muted">Consultar</h6>
                                                <h3 class="font-weight-bold">El Inventario Actual</h3>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 stat my-3">
                                            <div class="mx-auto">
                                                <h6 class="text-muted">Observar</h6>
                                                <h3 class="font-weight-bold">Gráficas de Consulta</h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
