                        ...
                        <div class="container text-center">
                            <div class="row">
                                <div class="col-lg-12 w-100">
                                    <a href="InventarioServlet?accion=reportar" class="btn btn-primary w-100"><i class="icon ion-md-document lead"></i>
                                        Reporte</a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            ...
                                            <c:forEach items="${inventario}" var="i">
                                                <tr>
                                                    <td><c:out value="${i.idProducto}" /></td>
                                                    <td><c:out value="${i.nombreCategoria}" /></td>
                                                    <td><c:out value="${i.cantidadActual}" /></td>
                                                </tr>
                                            </c:forEach>
                                        </table>
                                    </div>
