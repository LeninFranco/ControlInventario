                ...
                <div id="content">
                    <section class="bg-light py-3">
                        <div class="container text-center">
                            <div class="row">
                                <div class="col-lg-12">
                                    <h1 class="font-weight-bold mb-0">Consulta de gráficas</h1>
                                    <p class="lead text-muted">En esta sección podrá apreciar las gráficas sobre información relevante del inventario</p>
                                </div>
                            </div>
                        </div>
                    </section>
