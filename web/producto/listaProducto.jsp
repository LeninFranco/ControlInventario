                ...
                <div id="content">
                    <section class="bg-light py-3">
                        <div class="container text-center">
                            <div class="row">
                                <div class="col-lg-6">
                                    <a href="ProductoServlet?accion=crear" class="btn btn-primary w-100"><i
                                            class="icon ion-md-add-circle-outline lead"></i> Añadir</a>
                                </div>
                                <div class="col-lg-6 w-100">
                                    <a href="ProductoServlet?accion=reportar" class="btn btn-primary w-100"><i class="icon ion-md-document lead"></i>
                                        Reporte</a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            ...
                                            %>
                                            <tr>
                                                <td><%= producto.getEntidad().getIdProducto()%></td>
                                                <td><%= producto.getEntidad().getNombreProducto()%></td>
                                                <td><%= producto.getEntidad().getCostoUnitario()%></td>
                                                <td><%= producto.getEntidad().getPrecioUnitario()%></td>
                                                <%
                                                    cdto.getEntidad().setIdCategoria(producto.getEntidad().getIdCategoria());
                                                    CategoriaDTO cdtoR = cdao.selectOne(cdto);
                                                %>
                                                <td><%= cdtoR.getEntidad().getNombreCategoria()%></td>
                                                <td>
                                                    <a class="btn btn-danger" href="ProductoServlet?accion=eliminar&id=<%= producto.getEntidad().getIdProducto()%>"><i class="icon ion-md-trash"></i></a>
                                                    <a class="btn btn-success" href="ProductoServlet?accion=editar&id=<%= producto.getEntidad().getIdProducto()%>"><i class="icon ion-md-create"></i></a>
                                                </td>
                                            </tr>
                                            <%
                                                }
