                    ...
                    <section class="bg-light py-3">
                        <div class="container">
                            <div class="card rounded-0">
                                <div class="card-body">
                                    <form action="ProductoServlet?accion=guardar" method="post">
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <input type="number" min="0" max="9999" step="0.1" name="costo" class="form-control" required>
                                        </div>
                                        <div class="mb-3">
                                            <label>Precio Unitario</label>
                                        </div>
                                        <div class="mb-3">
                                            <input type="number" min="0" max="9999" step="0.1" name="precio" class="form-control" required>
                                        </div>
                                        <div class="mb-3">
