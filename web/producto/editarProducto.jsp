                    ...
                    <section class="bg-light py-3">
                        <div class="container">
                            <div class="card rounded-0">
                                <div class="card-body">
                                    <form action="ProductoServlet?accion=actualizar" method="post">
                                        <%
                                        ...
                                        <div class="mb-3">
                                            <input type="text" name="id" class="form-control" value="<%= p.getEntidad().getIdProducto() %>" readonly>
                                        </div>
                                        <div class="mb-3">
                                            <label>Nombre del Producto</label>
                                        </div>
                                        <div class="mb-3">
                                            <input type="text" name="nombre" class="form-control" value="<%= p.getEntidad().getNombreProducto() %>" required>
                                        </div>
                                        <div class="mb-3">
                                            <label>Descripción del Producto</label>
                                        </div>
                                        <div class="mb-3">
                                            <input type="text" name="descripcion" class="form-control" value="<%= p.getEntidad().getDescripcionProducto() %>" required>
                                        </div>
                                        <div class="mb-3">
                                            <label>Costo Unitario</label>
                                        </div>
                                        <div class="mb-3">
                                            <input type="number" min="0" max="9999" step="0.1" name="costo" class="form-control" value="<%= p.getEntidad().getCostoUnitario() %>" required>
                                        </div>
                                        <div class="mb-3">
                                            <label>Precio Unitario</label>
                                        </div>
                                        <div class="mb-3">
                                            <input type="number" min="0" max="9999" step="0.1" name="precio" class="form-control" value="<%= p.getEntidad().getPrecioUnitario() %>" required>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <select class="form-control" name="categoria">
                                                <%
                                                  ArrayList<CategoriaDTO> categorias = (ArrayList<CategoriaDTO>) request.getAttribute("categorias");
                                                  for(CategoriaDTO categoria : categorias){
                                                      if(p.getEntidad().getIdCategoria() == categoria.getEntidad().getIdCategoria()){
                                                %>
                                                        <option value="<%= categoria.getEntidad().getIdCategoria() %>" selected><%= categoria.getEntidad().getNombreCategoria() %></option>
                                                <%
                                                      }  else {
                                                %>
                                                        <option value="<%= categoria.getEntidad().getIdCategoria() %>"><%= categoria.getEntidad().getNombreCategoria() %></option>
                                                <%
                                                      }  
                                                %>        
                                                <%
