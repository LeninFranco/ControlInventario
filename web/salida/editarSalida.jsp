                    ...
                    <section class="bg-light py-3">
                        <div class="container">
                            <div class="card rounded-0">
                                <div class="card-body">
                                    <form action="SalidaServlet?accion=actualizar" method="post">
                                        <%
                                           SalidaDTO s = (SalidaDTO) request.getAttribute("salida");
                                        %>
                                        <div class="mb-3">
                                            <label>ID Salida</label>
                                        </div>
                                        <div class="mb-3">
                                            <input type="text" name="id" class="form-control" value="<%= s.getEntidad().getIdSalida() %>" readonly>
                                        </div>
                                        <div class="mb-3">
                                            <label>Cantidad de Salida</label>
                                        </div>
                                        <div class="mb-3">
                                            <input type="number" min="0" max="9999" step="1" name="cantidad" class="form-control" value="<%= s.getEntidad().getCantidadSalida() %>" required>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="producto">
                                                <%
                                                  ...
                                                  for(ProductoDTO producto : productos){
                                                      if(s.getEntidad().getIdProducto() == producto.getEntidad().getIdProducto()){
                                                %>
