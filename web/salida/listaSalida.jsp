...
<%@page import="com.ipn.mx.modelo.dto.SalidaDTO"%>
                ...
                <div id="content">
                    <section class="bg-light py-3">
                        <div class="container text-center">
                            <div class="row">
                                <div class="col-lg-6">
                                    <a href="SalidaServlet?accion=crear" class="btn btn-primary w-100"><i
                                            class="icon ion-md-add-circle-outline lead"></i> Añadir</a>
                                </div>
                                <div class="col-lg-6 w-100">
                                    <a href="SalidaServlet?accion=reportar" class="btn btn-primary w-100"><i class="icon ion-md-document lead"></i>
                                        Reporte</a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            ...
                                            <%
                                                ArrayList<SalidaDTO> salidas = (ArrayList<SalidaDTO>) request.getAttribute("salidas");
                                                ProductoDAO pdao = new ProductoDAO();
                                                ProductoDTO pdto = new ProductoDTO();
                                                for (SalidaDTO salida : salidas) {
                                            %>
                                            <tr>
                                                <td><%= salida.getEntidad().getIdSalida()%></td>
                                                <td><%= salida.getEntidad().getFechaSalida()%></td>
                                                <td><%= salida.getEntidad().getCantidadSalida()%></td>
                                                <td><%= salida.getEntidad().getCostoTotal()%></td>
                                                <td><%= salida.getEntidad().getVentaTotal()%></td>
                                                <%
                                                    pdto.getEntidad().setIdProducto(salida.getEntidad().getIdProducto());
                                                    ProductoDTO pdtoR = pdao.selectOne(pdto);
                                                %>
                                                <td><%= pdtoR.getEntidad().getNombreProducto()%></td>
                                                <td>
                                                    <a class="btn btn-success" href="SalidaServlet?accion=editar&id=<%= salida.getEntidad().getIdSalida()%>"><i class="icon ion-md-create"></i></a>
                                                </td>
                                            </tr>
                                            <%
                                                }
