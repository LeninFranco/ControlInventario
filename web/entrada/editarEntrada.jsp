                    ...
                    <section class="bg-light py-3">
                        <div class="container">
                            <div class="card rounded-0">
                                <div class="card-body">
                                    <form action="EntradaServlet?accion=actualizar" method="post">
                                        <%
                                            EntradaDTO e = (EntradaDTO) request.getAttribute("entrada");
                                        %> 
                                        <div class="mb-3">
                                            <label>ID Entrada</label>
                                        </div>
                                        <div class="mb-3">
                                            <input type="text" name="id" class="form-control" value="<%= e.getEntidad().getIdEntrada() %>" readonly>
                                        </div>
                                        <div class="mb-3">
                                            <label>Cantidad de Entrada</label>
                                        </div>
                                        <div class="mb-3">
                                            <input type="number" min="0" max="9999" step="1" name="cantidad" class="form-control" value="<%= e.getEntidad().getCantidadEntrada() %>" required>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="producto">
                                                <%
                                                  ...
                                                  for(ProductoDTO producto : productos){
                                                      if(e.getEntidad().getIdProducto() == producto.getEntidad().getIdProducto()){
                                                %>
