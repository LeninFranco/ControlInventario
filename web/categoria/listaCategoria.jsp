                ...
                <div id="content">
                    ...
                    <section class="bg-light py-3">
                        <div class="container text-center">
                            <div class="row">
                                <div class="col-lg-6">
                                    <a href="CategoriaServlet?accion=crear" class="btn btn-primary w-100"><i
                                            class="icon ion-md-add-circle-outline lead"></i> Añadir</a>
                                </div>
                                <div class="col-lg-6 w-100">
                                    <a href="CategoriaServlet?accion=reportar" class="btn btn-primary w-100"><i class="icon ion-md-document lead"></i>
                                        Reporte</a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            ...
                                            <c:forEach items="${categorias}" var="categoria">
                                                <tr>
                                                    <td><c:out value="${categoria.entidad.idCategoria}" /></td>
                                                    <td><c:out value="${categoria.entidad.nombreCategoria}" /></td>
                                                    <td>
                                                        <a class="btn btn-danger" href="CategoriaServlet?accion=eliminar&id=${categoria.entidad.idCategoria}"><i class="icon ion-md-trash"></i></a>
                                                        <a class="btn btn-success" href="CategoriaServlet?accion=editar&id=${categoria.entidad.idCategoria}"><i class="icon ion-md-create"></i></a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </table>
