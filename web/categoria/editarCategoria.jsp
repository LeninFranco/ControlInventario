                            ...
                            <div class="card rounded-0">
                                <div class="card-body">
                                    <form action="CategoriaServlet?accion=actualizar" method="post">
                                        ...
                                        <div class="mb-3">
                                            <input type="text" name="id" class="form-control" value="${categoria.entidad.idCategoria}" readonly>
                                        </div>
                                        <div class="mb-3">
                                            <label>Nombre de la Categoria</label>
                                        </div>
                                        <div class="mb-3">
                                            <input type="text" name="nombre" class="form-control" value="${categoria.entidad.nombreCategoria}" required>
                                        </div>
                                        <div class="mb-3">
